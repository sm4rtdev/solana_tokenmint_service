                ...
                {token ?
                    <div>
                        <MenubarTrigger className=" relative">
                            {
                                avatar ? <img src={avatar} alt="avatar" className="size-12 rounded-full" /> :
                        ...
                        <MenubarContent className=" absolute -right-14">
                            ...
                            <MenubarSeparator />
                            <MenubarItem onClick={() => {localStorage.removeItem('token'); route.push('/reset')}}>
                                Reset Password
                            </MenubarItem>
                            <MenubarSeparator />
                            <MenubarItem onClick={() => {localStorage.removeItem('token'); route.push('/auth/signin')}}>
                                Sign Out
                            </MenubarItem>
                        </MenubarContent>
                    </div>
